...
class Global_Temp(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 ...
                 target='OT', scale=False, timeenc=0, freq='h', num_nodes=-1):
        ...
        self.mask = np.zeros((self.his_len, self.num_nodes))
    ...
    def __getitem__(self, index):
        ...
        h_begin = s_end - self.his_len
        if s_end - self.his_len < 0:
            seq_his = self.mask
        else:
            seq_his = self.data_x[h_begin:s_end]
        return seq_x, seq_y, seq_x_mark, seq_y_mark, seq_his
