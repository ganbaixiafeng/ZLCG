...
from basicts.losses.losses import masked_mae, masked_rmse, masked_mape
...
class STEPRunner(BaseTimeSeriesForecastingRunner):
    ...
    def forward(self, data: tuple, epoch: int = None, iter_num: int = None, train: bool = True, **kwargs) -> tuple:
        ...
        prediction = self.model(history_data=history_data, long_history_data=long_history_data, future_data=None,
                                batch_seen=iter_num, epoch=epoch)
