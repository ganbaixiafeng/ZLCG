...
def generate_adj_pems03():
    raw_data_dir = PEMS_ROOT / "datasets" / "raw_data" / "PEMS03"
    distance_df_filename, num_of_vertices = str(raw_data_dir / "PEMS03.csv"), 358
    ...
    with open(raw_data_dir / "adj_PEMS03.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open(raw_data_dir / "adj_PEMS03_distance.pkl", "wb") as f:
