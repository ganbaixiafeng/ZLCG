...
def generate_adj_pems04():
    raw_data_dir = PEMS_ROOT / "datasets" / "raw_data" / "PEMS04"
    distance_df_filename, num_of_vertices = str(raw_data_dir / "PEMS04.csv"), 307
    ...
    with open(raw_data_dir / "adj_PEMS04.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open(raw_data_dir / "adj_PEMS04_distance.pkl", "wb") as f:
