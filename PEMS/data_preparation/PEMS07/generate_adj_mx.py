...
def generate_adj_pems07():
    raw_data_dir = PEMS_ROOT / "datasets" / "raw_data" / "PEMS07"
    distance_df_filename, num_of_vertices = str(raw_data_dir / "PEMS07.csv"), 883
    ...
    with open(raw_data_dir / "adj_PEMS07.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open(raw_data_dir / "adj_PEMS07_distance.pkl", "wb") as f:
