...
def generate_adj_pems08():
    raw_data_dir = PEMS_ROOT / "datasets" / "raw_data" / "PEMS08"
    distance_df_filename, num_of_vertices = str(raw_data_dir / "PEMS08.csv"), 170
    ...
    with open(raw_data_dir / "adj_PEMS08.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open(raw_data_dir / "adj_PEMS08_distance.pkl", "wb") as f:
